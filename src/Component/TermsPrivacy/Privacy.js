...
const Privacy = () => {
  return (
    <div>
       <section class="container py-5 para-color1">
            <h2>Privacy Policy</h2>
            <p>At a2zsms, accessible from https://a2zsms.in/, one of our main priorities is the privacy of our visitors.
                This Privacy Policy document contains types of information that is collected and recorded by a2zsms and <br></br>
                how we use it. <br></br> If you have additional questions or require more information about our Privacy Policy,
                do not hesitate to
                contact us. <br></br>
                This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards
                to the information that they shared and/or collect in a2zsms. This policy is not applicable to any
            ...
            <h4>Log Files</h4>
            <p>a2zsms follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>Like any other website, a2zsms uses "cookies". These cookies are used to store information including
            ...
            <p>Some of advertisers on our site may use cookies and web beacons. Our advertising partners are listed
                below. Each of our advertising partners has their own Privacy Policy for their policies on user data. For
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of a2zsms.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on a2zsms, which are sent directly to users'
            ...
            <p>Note that a2zsms has no access to or control over these cookies that are used by third-party advertisers.</p>
            <h4>Third Party Privacy Policies</h4>
            <p>a2zsms's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                consult the respective Privacy Policies of these third-party ad servers for more detailed information. It
                may include their practices and instructions about how to opt-out of certain options. <br></br>
            ...
            <h4>CCPA Privacy Rights (Do Not Sell My Personal Information)
            </h4>
            <p>Under the CCPA, among other rights, California consumers have the right to: <br></br>
                ...
                pieces of personal data that a business has collected about consumers. <br></br>
            ...
            <p>We would like to make sure you are fully aware of all of your data protection rights. Every user is entitled
                ...
                small fee for this service. <br></br>
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We encourage
                ...
                a2zsms does not knowingly collect any Personal Identifiable Information from children under the age of
